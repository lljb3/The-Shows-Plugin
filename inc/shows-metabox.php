<?php
	...
	class Event_Info_Meta_Box {
		...
		public function add_meta_box_callback( $post ) {
			...
			echo 'Insert event information here to be generated on the front page';
	...
	new Event_Info_Meta_Box;

    // Rename the Image Metabox
    function replace_featured_image_box() {  
        remove_meta_box( 'postimagediv', 'shows', 'side' );  
        add_meta_box('postimagediv', __('Event Flyer'), 'post_thumbnail_meta_box', 'shows', 'side', 'low');  
    }
